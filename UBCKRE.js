...
(async function() {
    if (window.UBCver) {
        console.warn("UBCKRE already loaded. No double loading");
        return;
    }
    ...
    const modApi = bcModSDK.registerMod({
        ...
        version: UBCver,
        repository: 'https://github.com/tetris245/UBCKRE',
    });
    ...
    async function MoanerLoginListener() {
        while (!MoanerIsLoaded) {
            try {
                ...
                Player.UBC = UBCver;
                console.log("UBCKRE loaded: Version " + UBCver);
                if (NPCpunish == true) {
    ...
    async function ULTRALoginRun() {
        modApi.hookFunction('LoginRun', 4, (args, next) => {
            DrawButton(750, 120, 500, 60, "UBCKRE " + UBCver + " Ready!", "Pink", "", "");
            next(args);
        });
    }
    ...
    async function ULTRAMainHallRun() {
	    ...
	    DrawText("UBCKRE", 130, 615, "White", "Black");
    ...
    async function ULTRAMainHallClick() {
	    ...
	    if (MouseIn(240, 585, 420, 90))
                window.open('https://github.com/tetris245/UBCKRE/releases', '_blank');
            if (MouseIn(240, 695, 420, 90))
                window.open('https://github.com/tetris245/UBCKRE/wiki', '_blank');
            next(args);
        });
    }
    ...
    async function ULTRAAppearanceRun() {
        modApi.hookFunction('AppearanceRun', 4, (args, next) => {
            if (CharacterAppearanceMode == "Wardrobe") {
                DrawButton(1510, 240, 100, 60, "Export", "#50E992", "", "Full UBCKRE Export");
                ...
                DrawButton(1870, 240, 100, 60, "Import3", "#50E992", "", "Full UBCKRE Import");
            }
            next(args);
        });
    }
            ...
            if (CharacterAppearanceMode == "Wardrobe") {
                if ((MouseX >= 1510) && (MouseX < 1610) && (MouseY >= 240) && (MouseY < 290)) {
                    if (ServerPlayerIsInChatRoom()) {
                        ...
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: Appearance saved.</p>\n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if ((args === "") && (ReputationGet("Asylum") < 0)) {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: You must specify minutes if you are a patient.</p>"
                );
            } else {
                var minutes = args;
                ChatRoomSetLastChatRoom("");
    ...
    CommandCombine([{
        ...
        Action: () => {
            if (this.AutoKickOn == false || this.AutoKickOn == undefined) {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'>UBCKRE: AutoKick Ready.</p>"
                );
                AutoKickOn = true;
                ...
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'>UBCKRE: AutoKick Disabled.</p>"
                );
            }
        }
    }])
    ...
    CommandCombine([{
        ...
        Action: () => {          
            ...
            ChatRoomSendLocal(
                "<p style='background-color:#5fbd7a'>UBCKRE: You can use more standard backgrounds now.</p>"
            );
        }
    }])
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The bg2 command must be followed by a number. List of Bondage Brawl backgrounds:\n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            ...
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The bg3 command must be followed by a number. List of Bondage College backgrounds:\n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The blur command must be followed by a number between 0 and 4.\n" +
                    " \n" +
                ...
                if (brlevel == 0) {
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: No more forced blur effect.</p>"
                    );
                    blureffect = false;
                    Blur1On = false;
                    Blur2On = false;
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: Light blur effect enabled.</p>"
                    );
                    blureffect = true;
                    Blur1On = true;
                    Blur2On = false;
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: Normal blur effect enabled.</p>"
                    );
                    blureffect = true;
                    Blur1On = false;
                    Blur2On = true;
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: Heavy blur effect enabled.</p>"
                    );
                    blureffect = true;
                    Blur1On = false;
                    Blur2On = false;
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: Total blur effect enabled.</p>"
                    );
                    blureffect = true;
                    Blur1On = false;
                    Blur2On = false;
    ...
    CommandCombine([{
        ...
        Action: () => {
            ...
            ChatRoomSendLocal(
                "<p style='background-color:#5fbd7a'>UBCKRE: You feel all your skills boosted. Changes can be seen in information panel.</p>"
            );
        }
    }])
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The btalk command must be followed by the words you want to say.</p>"
                );
            } else {
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The carddesk command must be followed by a number between 0 and 8.\n" +
                    " \n" +
                    "Available desks:\n" +
                    "0 Original Default\n" +
                ...
                if ((desk > -1) && (desk < 9) && (desk != cdesk)) {
                    ...
                    M_MOANER_saveControls();
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Default desk changed for the Bondage Club Card Game.</p>"
                    );
                }
            }
        }
    ...
    CommandCombine([{
        ...
        Action: () => {
            ...
            ChatRoomSendLocal(
                "<p style='background-color:#5fbd7a'>UBCKRE: All extra cards of the Bondage Club Card Game now added.</p>"
            );
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The cardfame command must be followed by a number between 200 and 600.</p>"
                );
            } else {
                var fame = args;
                if ((fame > 199) && (fame < 601) && (fame != cfame)) {
                    ...
                    M_MOANER_saveControls();
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Fame level changed for the high fame mode of the Bondage Club Card Game.</p>"
                    );
                }
            }
        }
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ...
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'>UBCKRE: No more extra cards in the Bondage Club Card Game.</p>"
                );
                Player.Game.ClubCard.Reward = "";
                ServerAccountUpdate.QueueData({
                    Game: Player.Game
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The chess command must be followed by a number between 1 and 3.\n" +
                    " \n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The colorchanger command:\n" +
            ...
            if ((args === "custom") || (args === "set") || (args === "select")) {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'>UBCKRE: You have 5 seconds to click on target, select area. If successful, will be returned. If not, retry.</p>"
                );
                setTimeout(function() {
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Welcome to Bondage Club Diaper Wetter! Where we make sure babies use their diapers!\n" +
                    " \n" +
                ...
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Diaper customisation (before using /diaper start):\n" +
                ...
                if (feature == "change1") {
                    ...
                    if (targetname == null) {
                        if (InventoryGet(Player, "Panties") == null) {
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: You don't have normal diapers!</p>"
                            );
                        ...
                        if (target[0] != null) {
                            ...
                            if (InventoryGet(target[0], "Panties") == null) {
                                ChatRoomSendLocal(
                                    "<p style='background-color:#5fbd7a'>UBCKRE: " + tgpname + " does not have normal diapers!</p>"
                                );
                ...
                if (feature == "change2") {
                    ...
                    if (targetname == null) {
                        if (InventoryGet(Player, "ItemPelvis") == null) {
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: You don't have chastity diapers!</p>"
                            );
                        ...
                        if (target[0] != null) {
                            ...
                            if (InventoryGet(target[0], "ItemPelvis") == null) {
                                ChatRoomSendLocal(
                                    "<p style='background-color:#5fbd7a'>UBCKRE: " + tgpname + " does not have chastity diapers!</p>"
                                );
                ...
                if (feature == "change3") {
                    ...
                    if (targetname == null) {
                        if ((InventoryGet(Player, "Panties") == null) && (InventoryGet(Player, "ItemPelvis") == null)) {
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: You don't have a diaper! Get one on you before you make a mess!</p>"
                            );
                            ...
                            if (InventoryGet(Player, "ItemPelvis").Asset.Name == "BulkyDiaper" || InventoryGet(Player, "ItemPelvis").Asset.Name === "PoofyDiaper") {
                                ChatRoomSendLocal(
                                    "<p style='background-color:#5fbd7a'>UBCKRE: You don't have two layers of diapers!</p>"
                                );
                            } else {
                                ChatRoomSendLocal(
                                    "<p style='background-color:#5fbd7a'>UBCKRE: You don't have a diaper! Get one on you before you make a mess!</p>"
                        ...
                        if (target[0] != null) {
                            ...
                            if ((InventoryGet(target[0], "Panties") == null) && (InventoryGet(target[0], "ItemPelvis") == null)) {
                                ChatRoomSendLocal(
                                    "<p style='background-color:#5fbd7a'>UBCKRE: " + tgpname + " does not have a diaper! Get one on " + tgpr2 + " before " + tgpr4 + " makes a mess!</p>"
                                );
                                ...
                                if (InventoryGet(target[0], "ItemPelvis").Asset.Name == "BulkyDiaper" || InventoryGet(target[0], "ItemPelvis").Asset.Name === "PoofyDiaper") {
                                    ChatRoomSendLocal(
                                        "<p style='background-color:#5fbd7a'>UBCKRE: " + tgpname + " does not have two layers of diapers!</p>"
                                    );
                                } else {
                                    ChatRoomSendLocal(
                                        "<p style='background-color:#5fbd7a'>UBCKRE: " + tgpname + " does not have a diaper! Get one on " + tgpr2 + " before " + tgpr4 + " makes a mess!</p>"
                ...
                if (feature == "setdesperation") {
                    ...
                    setchange = "";
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: Your desperation level has been changed.</p>"
                    );
                }
                if (feature == "setmesschance") {
                    ...
                    setchange = "";
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: Your chance to mess diapers has been changed.</p>"
                    );
                }
                if (feature == "setmess1") {
                    if (InventoryGet(Player, "Panties") != null) {
                        if (InventoryGet(Player, "Panties").Asset.Name == "BulkyDiaper" || InventoryGet(Player, "Panties").Asset.Name === "PoofyDiaper") {
                            ...
                            if (setchange < diaperDefaultValues.wetLevelInner) {
                                ...
                                setchange = "";
                                ChatRoomSendLocal(
                                    "<p style='background-color:#5fbd7a'>UBCKRE: Your mess level for normal diapers has been changed.</p>"
                                );
                            }
                        }
                    }
                    ...
                    if (InventoryGet(Player, "ItemPelvis") != null) {
                        if (InventoryGet(Player, "ItemPelvis").Asset.Name == "BulkyDiaper" || InventoryGet(Player, "ItemPelvis").Asset.Name === "PoofyDiaper") {
                            ...
                            if (setchange < diaperDefaultValues.wetLevelOuter) {
                                ...
                                setchange = "";
                                ChatRoomSendLocal(
                                    "<p style='background-color:#5fbd7a'>UBCKRE: Your mess level for chastity diapers has been changed.</p>"
                                );
                            }
                        }
                    }
                ...
                if (feature == "setregression") {
                    ...
                    setchange = "";
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: Your regression level has been changed.</p>"
                    );
                }
                if (feature == "settimer") {
                    var setchange = stringDiaper2[1];
                    ...
                    setchange = "";
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: Your wet/mess timer has been changed.</p>"
                    );
                }
                if (feature == "setwetchance") {
                    ...
                    setchange = "";
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: Your chance to wet diapers has been changed.</p>"
                    );
                }
                if (feature == "setwet1") {
                    if (InventoryGet(Player, "Panties") != null) {
                        if (InventoryGet(Player, "Panties").Asset.Name == "BulkyDiaper" || InventoryGet(Player, "Panties").Asset.Name === "PoofyDiaper") {
                            ...
                            if (setchange > diaperDefaultValues.messLevelInner) {
                                ...
                                setchange = "";
                                ChatRoomSendLocal(
                                    "<p style='background-color:#5fbd7a'>UBCKRE: Your wet level for normal diapers has been changed.</p>"
                                );
                            }
                        }
                    }
                    ...
                    if (InventoryGet(Player, "ItemPelvis") != null) {
                        if (InventoryGet(Player, "ItemPelvis").Asset.Name == "BulkyDiaper" || InventoryGet(Player, "ItemPelvis").Asset.Name === "PoofyDiaper") {
                            ...
                            if (setchange > diaperDefaultValues.messLevelOuter) {
                                ...
                                setchange = "";
                                ChatRoomSendLocal(
                                    "<p style='background-color:#5fbd7a'>UBCKRE: Your wet level for chastity diapers has been changed.</p>"
                                );
                            }
                        }
                    }
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The difficulty command must be followed by a number between 0 and 3.\n" +
                    " \n" +
                    "Available difficulty modes:\n" +
                    "0 roleplay\n" +
                    "1 regular\n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The font command must be followed by a font number and optionally a size number.\n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The frlist command must be followed by the lobby for which you want to have clickable links.\n" +
            ...
            if (args === "fclub") {
                if ((InventoryGet(Player, "Pronouns").Asset.Name == "SheHer") &&
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: Only females have access to this lobby.</p>"
                    );
                }
            }
            if (args === "mclub") {
                if ((InventoryGet(Player, "Pronouns").Asset.Name == "HeHim") &&
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: Only males have access to this lobby.</p>"
                    );
                }
            }
            if (args === "xclub") {
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The game command must include a minigame.\n" +
                    "Available minigames:\n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The ggts command must be followed by two numbers to  specify minutes and level (1-6).<p>"
                );
            } else {
    ...
    CommandCombine([{
        ...
        Action: () => {
            ChatRoomSendLocal(
                "<p style='background-color:#5fbd7a'>UBCKRE: Every item in the game now added.</p>"
            );
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The gtalk command must be followed by a number between 1 and 9, then the words you want to say.\n" +
                    " \n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The hdvibe command must be followed by 5 numbers for crotch shield, back shield, modules, intensity and orgasm mode.\n" +
                    " \n" +
                ...
                if (InventoryGet(Player, "ItemPelvis") != null) {
                    if (InventoryGet(Player, "ItemPelvis").Asset.Name == "HeavyDutyBelt") {
                        ...
                        if ((chd > -1) && (chd < 3) && (bhd > -1) && (bhd < 2) && (mhd > -1) && (mhd < 4) && (ihd > -1) && (ihd < 5) && (ohd > -1) && (ohd < 3)) {
                            ...
                            ChatRoomCharacterUpdate(Player);
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: The settings of your Heavy Duty Belt have been modified.</p>"
                            );
                        }
                    }
                }
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The hear command must be followed by a number between 0 and 4.\n" +
                    "Notes:\n" +
                ...
                if (dl == 0) {
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: Back to normal hearing mode.</p>"
                    );
                }
                if (dl == 1) {
                    GetDeafLevel1();
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: You are now in light deafness mode.</p>"
                    );
                }
                if (dl == 2) {
                    GetDeafLevel2();
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: You are now in normal deafness mode.</p>"
                    );
                }
                if (dl == 3) {
                    GetDeafLevel3();
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: You are now in heavy deafness mode.</p>"
                    );
                }
                if (dl == 4) {
                    GetDeafLevel4();
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: You are now in total deafness mode.</p>"
                    );
                }
            }
        }
    ...
    CommandCombine([{
        ...
        Action: (_, command, args) => {
            ...
            if (!targetname) {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The hint command must be followed by a target and the hint you want to add to locks with password.<p>"
                );
            } else {
    ...
    CommandCombine([{
	    ...
	    if (Player.OnlineSharedSettings.ScriptPermissions.Hide.permission == 0) {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: To use the invisible command, you need first to allow Scripts in BC settings.<p>"
                );
            } else {    
                ServerSend("ChatRoomChat", {
                    Content: "Beep",
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The itemcolor command must be followed by a color code in the format #000000 and optionally a target.</p>"
                );
            } else {
                var stringItc1 = args;
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            ...
            if (args === "debug") {
                ...
                KDDebugMode = true;
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'>UBCKRE: KD Debug mode enabled</p>"
                );
                ...
                if (this.DeviousOn == undefined || this.DeviousOn == false) {
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: Devious Challenge enabled</p>"
                    );
                } else {
                    DeviousOn = false;
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: Devious Challenge disabled</p>"
                    );
                }
            } else {
                ArcadeRun();
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ...
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'>UBCKRE: All UBC/Moaner parameters have been deleted. Make a full logout/login then use the appropriate commands to set the parameters that you like.</p>"
                );
            }
        }
    }])
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The lock command has several syntaxes:\n" +
                ...
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Special parameters of lock command:\n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The login command must be followed by an account name and a password.</p>"
                );
            } else {
    ...
    CommandCombine([{
        ...
        Action: () => {
            ...
            ChatRoomSendLocal(
                "<p style='background-color:#5fbd7a'>UBCKRE: A few things have to be set manually. See the /roleplay and /rolequit commands.</p>"
            );
        }
    }])
    ...
    CommandCombine([{
        ...
        Action: (_, command, args) => {
            ...
            if (!option) {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The message command must be followed by a command and the message you want instead of the default message.\n" +
                ...
                if (custom != "") {
                    if (option == "clothes") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for clothes command on yourself.</p>"
                            ); 
                        } else if (custom == "?") {
                            Clothes = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for clothes command on yourself.</p>"
                            );
                        } else {
                            Clothes = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for clothes command on yourself.</p>"
                            );
                        } 
                    }
                    if (option == "lock") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for lock command on yourself.</p>"
                            ); 
                        } else if (custom == "?") {
                            Mlock = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for lock command on yourself.</p>"
                            );
                        } else {
                            Mlock = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for lock command on yourself.</p>"
                            );
                        } 
                    }
                    if (option == "naked") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for naked command on yourself.</p>"
                            ); 
                        } else if (custom == "?") {
                            Naked = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for naked command on yourself.</p>"
                            );
                        } else {
                            Naked = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for naked command on yourself.</p>"
                            );
                        } 
                    }
                    if (option == "pet") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for pet command on yourself.</p>"
                            ); 
                        } else if (custom == "?") {
                            Pet = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for pet command on yourself.</p>"
                            );
                        } else {
                            Pet = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for pet command on yourself.</p>"
                            );
                        } 
                    }
                    if (option == "randomize") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for randomize command on yourself.</p>"
                            ); 
                        } else if (custom == "?") {
                            Randomize = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for randomize command on yourself.</p>"
                            );
                        } else {
                            Randomize = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for randomize command on yourself.</p>"
                            );
                        } 
                    }
                    if (option == "restrain") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for restrain command on yourself.</p>"
                            ); 
                        } else if (custom == "?") {
                            Restrain = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for restrain command on yourself.</p>"
                            );
                        } else {
                            Restrain = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for restrain command on yourself.</p>"
                            );
                        } 
                    }
		    if (option == "solidity") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for solidity command to escape yourself special devices.</p>"
                            ); 
                        } else if (custom == "?") {
                            Solidity = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for solidity command to escape yourself special devices.</p>"
                            );
                        } else {
                            Solidity = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for solidity command to escape yourself special devices.</p>"
                            );
                        } 
                    }
                    if (option == "tclothes") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for clothes command on other players.</p>"
                            ); 
                        } else if (custom == "?") {
                            Tclothes = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for clothes command on other players.</p>"
                            );
                        } else {
                            Tclothes = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for clothes command on other players.</p>"
                            );
                        } 
                    }
                    if (option == "tlock") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for lock command on other players.</p>"
                            ); 
                        } else if (custom == "?") {
                            Tlock = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for lock command on other players.</p>"
                            );
                        } else {
                            Tlock = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for lock command on other players.</p>"
                            );
                        } 
                    }
                    if (option == "tnaked") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for naked command on other players.</p>"
                            ); 
                        } else if (custom == "?") {
                            Tnaked = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for naked command on other players.</p>"
                            );
                        } else {
                            Tnaked = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for naked command on other players.</p>"
                            );
                        } 
                    }
                    if (option == "totalrelease") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for totalrelease command on yourself.</p>"
                            ); 
                        } else if (custom == "?") {
                            Totalrelease = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for totalrelease command on yourself.</p>"
                            );
                        } else {
                            Totalrelease = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for totalrelease command on yourself.</p>"
                            );
                        } 
                    }
                    if (option == "tpet") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for pet command on other players.</p>"
                            ); 
                        } else if (custom == "?") {
                            Tpet = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for pet command on other players.</p>"
                            );
                        } else {
                            Tpet = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for pet command on other players.</p>"
                            );
                        } 
                    }
                    if (option == "trandomize") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for randomize command on other players.</p>"
                            ); 
                        } else if (custom == "?") {
                            Trandomize = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for randomize command on other players.</p>"
                            );
                        } else {
                            Trandomize = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for randomize command on other players.</p>"
                            );
                        } 
                    }
                    if (option == "trestrain") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for restrain command on other players.</p>"
                            ); 
                        } else if (custom == "?") {
                            Trestrain = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for restrain command on other players.</p>"
                            );
                        } else {
                            Trestrain = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for restrain command on other players.</p>"
                            );
                        } 
                    }
		    if (option == "tsolidity") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for solidity command when helping another player to escape special devices.</p>"
                            ); 
                        } else if (custom == "?") {
                            Tsolidity = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for solidity command when helping another player to escape special devices.</p>"
                            );
                        } else {
                            Tsolidity = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for solidity command when helping another player to escape special devices.</p>"
                            );
                        } 
                    }
                    if (option == "ttotalrelease") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for totalrelease command on other players.</p>"
                            ); 
                        } else if (custom == "?") {
                            Ttotalrelease = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for totalrelease command on other players.</p>"
                            );
                        } else {
                            Ttotalrelease = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for totalrelease command on other players.</p>"
                            );
                        } 
                    }
                    if (option == "tunderwear") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for underwear command on other players.</p>"
                            ); 
                        } else if (custom == "?") {
                            Tunderwear = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for underwear command on other players.</p>"
                            );
                        } else {
                            Tunderwear = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for underwear command on other players.</p>"
                            );
                        } 
                    }
                    if (option == "tunlock") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for unlock command on other players.</p>"
                            ); 
                        } else if (custom == "?") {
                            Tunlock = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for unlock command on other players.</p>"
                            );
                        } else {
                            Tunlock = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for unlock command on other players.</p>"
                            );
                        } 
                    }
                    if (option == "tuntie") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for untie command on other players.</p>"
                            ); 
                        } else if (custom == "?") {
                            Tuntie = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for untie command on other players.</p>"
                            );
                        } else {
                            Tuntie = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for untie command on other players.</p>"
                            );
                        } 
                    }
                    if (option == "underwear") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for underwear command on yourself.</p>"
                            ); 
                        } else if (custom == "?") {
                            Underwear = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for underwear command on yourself.</p>"
                            );
                        } else {
                            Underwear = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for underwear command on yourself.</p>"
                            );
                        } 
                    }
                    if (option == "unlock") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for unlock command on yourself.</p>"
                            ); 
                        } else if (custom == "?") {
                            Unlock = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for unlock command on yourself.</p>"
                            );
                        } else {
                            Unlock = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for unlock command on yourself.</p>"
                            );
                        } 
                    }
                    if (option == "untie") {
                        if (custom == "!") {
                            ...
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Silent mode saved for untie command on yourself.</p>"
                            ); 
                        } else if (custom == "?") {
                            Untie = "";
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: Back to default message for untie command on yourself.</p>"
                            );
                        } else {
                            Untie = custom;
                            M_MOANER_saveControls();
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: New message saved for untie command on yourself.</p>"
                            );
                        } 
                    }                    
                }
   ...
   CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The mission command must include a mission.\n" +
                    "Available missions:\n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Several actions are possible with the moaner command:\n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Options for outfit command:\n" +
            ...
            if (args === "load1") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'>UBCKRE: You have 5 seconds to click on target. If successful, the outfit will be loaded. If not, retry.</p>"
                );
                setTimeout(function() {
            ...
            if (args === "save1") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'>UBCKRE: You have 5 seconds to click on target. If successful, the outfit will be saved. If not, retry.</p>"
                );
                setTimeout(function() {
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The permission command must be followed by a number.\n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The plvibe command must be followed by 4 numbers for crotch shield, intensity, orgasm mode and shock level.\n" +
                    " \n" +
                    "Available crotch shields: \n" +
                ...
                if (InventoryGet(Player, "ItemPelvis") != null) {
                    if (InventoryGet(Player, "ItemPelvis").Asset.Name == "SciFiPleasurePanties") {
                        ...
                        if ((cpl > -1) && (cpl < 4) && (ipl > -1) && (ipl < 5) && (opl > -1) && (opl < 3) && (spl > -1) && (spl < 3)) {
                            ...
                            ChatRoomCharacterUpdate(Player);
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: The settings of your Sci-Fi Pleasure Panties have been modified.</p>"
                            );
                        }
                    }
                }
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The pose2 command must be followed by a pose and optionally a target.\n" +
                    " \n" +
                    "Available poses:\n" +
                ...
                if (targetname == null) {
                    if ((pose == "armsfree") &&
                        ...
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: To leave this position, use first /pose2 jump, then /pose2 reset (or /pose baseupper if FBC enabled).</p>"
                        );
                        CharacterSetFacialExpression(Player, "Emoticon", "Annoyed", 1);
                        CharacterSetActivePose(Player, null);
                        ChatRoomCharacterUpdate(Player);
                        ...
                        if (InventoryGet(Player, "ItemButt") == null) {
                            ...
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: You're too heavily tied to exercise.</p>"
                            );
                        }
                        ServerSend("ChatRoomChat", {
                            Content: "Beep",
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The reputation command must be followed by a reputation and a level.\n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ...
                Player.Difficulty = [];
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'>UBCKRE: Difficulty reset, select a new one in settings.</p>"
                );
            }
        }
    }])
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ...
                ServerPlayerInventorySync();
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'>UBCKRE: Accomplished. Visit store to buy new clothes and items.</p>"
                );
            }
        }
    }])
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The roleplay command must include a role.\n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The rolequit command must include a role or clubarea.\n" +
                    "You will be able to check the changes in your profile.\n" +
                    " \n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The s1 command must be followed by the words you want to say.</p>"
                );
            } else {
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The s2 command must be followed by the words you want to say.</p>"
                );
            } else {
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The s3 command must be followed by the words you want to say.</p>"
                );
            } else {
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The s4 command must be followed by the words you want to say.</p>"
                );
            } else {
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The search command must be followed by the lobby you want to explore.\n" +
                    "Available options: asylum, fclub, mclub, xclub.</p>"
                );
            }
            if (args === "asylum") {
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The see command must be followed by a vision mode number and optionally a blur level number.\n" +
                    "Notes:\n" +
                ...
                if (bl == 0) {
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: Back to normal vision mode.</p>"
                    );
                }
                if (bl == 1) {
                    GetBlindLevel1();
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: You are now in light blindness mode.</p>"
                    );
                }
                if (bl == 2) {
                    GetBlindLevel2();
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: You are now in normal blindness mode.</p>"
                    );
                }
                if (bl == 3) {
                    GetBlindLevel3();
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: You are now in heavy blindness mode.</p>"
                    );
                }
                if (br == 0) {
                    GetBlurLevel0();
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: Back to vision without blur effect.</p>"
                    );
                }
                if (br == 1) {
                    GetBlurLevel1();
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: A light blur effect is applied on your vision.</p>"
                    );
                }
                if (br == 2) {
                    GetBlurLevel2();
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: A normal blur effect is applied on your vision.</p>"
                    );
                }
                if (br == 3) {
                    GetBlurLevel3();
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: A heavy blur effect is applied on your vision.</p>"
                    );
                }
                if (br == 4) {
                    GetBlurLevel4();
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: A total blur effect is applied on your vision.</p>"
                    );
                }
            }
        }
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The sfchaste command must be followed by 5 numbers for model, front shield, back shield, tamper protection and orgasm mode.\n" +
                    " \n" +
                    "Available models: \n" +
                ...
                if (InventoryGet(Player, "ItemPelvis") != null) {
                    if (InventoryGet(Player, "ItemPelvis").Asset.Name == "FuturisticChastityBelt") {
                        ...
                        if ((msf > -1) && (msf < 4) && (fsf > -1) && (fsf < 2) && (bsf > -1) && (bsf < 2) && (tsf > -1) && (tsf < 3) && (osf > -1) && (osf < 2)) {
                            ...
                            ChatRoomCharacterUpdate(Player);
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: The settings of your Futuristic Chastity Belt have been modified.</p>"
                            );
                        }
                    }
                }
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The skill command must be followed by a skill and a level.\n" +
                    "You will be able to check the change in your profile.\n" +
                    " \n" +
                    "Available skills:\n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The solidity command must be followed by a number between 1 and 99, and optionally a target. </p>"
                );
            } else {
                var stringSol1 = args;
                ...
                if ((targetname == null) && (solidity > 0) && (solidity < 100)) {
                    ...
                    ChatRoomCharacterUpdate(Player);
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: The solidity of most current bindings has been changed.</p>"
                    );
                } else {
                    var target = ChatRoomCharacter.filter(A => (A.Name.toLowerCase().startsWith(targetname.toLowerCase())));
                    if (target[0] == null) {
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The spin command must be followed by the target whose wheel of fortune interests you.</p>"
                );
            } else {
                var targetname = args;
                var target = ChatRoomCharacter.filter(A => (A.Name.toLowerCase().startsWith(targetname.toLowerCase())));
                ...
                if (target[0] != null) {
                    if (!InventoryAvailable(target[0], "WheelFortune", "ItemDevices")) {
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Bad luck! This player does not have a wheel of fortune.</p>"
                        );
                    } else {
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The stutter command must be followed by a number between 0 and 4.\n" +
                    " \n" +
                ...
                if (stlevel == 0) {
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: No more stuttering.</p>"
                    );
                    Stutter1On = false;
                    Stutter2On = false;
                    Stutter3On = false;
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: You are now in light stuttering mode.</p>"
                    );
                    Stutter1On = true;
                    Stutter2On = false;
                    Stutter3On = false;
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: You are now in normal stuttering mode.</p>"
                    );
                    Stutter1On = false;
                    Stutter2On = true;
                    Stutter3On = false;
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: You are now in heavy stuttering mode.</p>"
                    );
                    Stutter1On = false;
                    Stutter2On = false;
                    Stutter3On = true;
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: You are now in total stuttering mode.</p>"
                    );
                    Stutter1On = false;
                    Stutter2On = false;
                    Stutter3On = false;
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The superdice command must be followed by a number between 2 and 999999999.<p>"
                );
            } else {
                var sides = args;
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The talk command must be followed by a number between -1 and 9.\n" +
                    " \n" +
                    "Available talk modes:\n" +
                    "-1 baby talk\n" +
                    "0 normal talk\n" +
                ...
                if (gaglevel == -1) {
                    if (this.BabyTalkOn == false || this.BabyTalkOn == undefined) {
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: You are now in baby talk mode.</p>"
                        );
                        GagTalkOn = false;
                        BabyTalkOn = true;
                    }
                ...
                if (gaglevel == 0) {
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: Back to normal talk mode.</p>"
                    );
                    BabyTalkOn = false;
                    GagTalkOn = false;
                }
                if ((gaglevel > 0) && (gaglevel < 9)) {
                    ...
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'>UBCKRE: You are now in gag talk mode.</p>"
                    );
                }
                if (gaglevel == 9) {
                    var bl = 0;
                    ...
                    if (bl == 1) {
                        if (this.BabyTalkOn == false || this.BabyTalkOn == undefined) {
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: You are now in real baby talk mode.</p>"
                            );
                            GagTalkOn = false;
                            BabyTalkOn = true;
                        }
                        ...
                        if (this.GagTalkOn == false || this.GagTalkOn == undefined) {
                            ...
                            if (gl == 0) {
                                ...
                                GagTalkOn = true;
                                ChatRoomSendLocal(
                                    "<p style='background-color:#5fbd7a'>UBCKRE: You are now in real gag talk mode.</p>"
                                );
                            }
                        } else {
                            GagTalkOn = false;
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The theme command must be followed by a number between 0 and 3.<p>"
                );
            } else {
                var theme = args;
                if ((theme > -1) && (theme < 4)) {
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The title command must be followed by a title.\n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The trsee command must be followed by 3 numbers for visor, deafening module and chin strap.\n" +
                    " \n" +
                    "Available visors:\n" +
                ...
                if (InventoryGet(Player, "ItemHood") != null) {
                    if (InventoryGet(Player, "ItemHood").Asset.Name == "TechnoHelmet1") {
                        ...
                        if ((vtr > -1) && (vtr < 6) && (dtr > -1) && (dtr < 4) && (ctr > -1) && (ctr < 2)) {
                            ...
                            ChatRoomCharacterUpdate(Player);
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: The settings of your Techno Helmet have been modified.</p>"
                            );
                        }
                    }
                }
    ...
    CommandCombine([{
        Tag: 'uhelp',
        Description: "(category): displays the UBCKRE commands.",
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The help is organized into categories. Use <b>/uhelp</b> (category). List of categories:\n" +
                    ...
                    "<b>settings</b> = commands to customize UBCKRE.\n" +
                    ...
                    "Visit also our <a href='https://github.com/tetris245/UBCKRE/wiki' target='_blank'>Wiki</a> and join this <a href='https://discord.gg/JUvYfSpCmN' target='_blank'>Discord</a></p>"
                );
            }
            if (args === "bondage") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Bondage commands - * = more info when using\n" +
            ...
            if (args === "character") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Character commands - * = more info when using\n" +
            ...
            if (args === "chat") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Chat commands - * = more info when using\n" +
            ...
            if (args === "clothing") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Clothing commands - * = more info when using\n" +
            ...
            if (args === "escape") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Escape commands - * = more info when using\n" +
            ...
            if (args === "extra") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Extra commands:\n" +
            ...
            if (args === "fun") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Fun commands - * = more info when using\n" +
            ...
            if (args === "kd") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: How to use the kd command:\n" +
            ...
            if (args === "misc") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Misc commands - * = more info when using\n" +
                    "<b>/login</b> (accountname) (password) = logs in a new account.\n" +
                    "<b>/relog</b> = relogs.\n" +
                    "<b>/uhelp</b> (category) = displays the UBCKRE commands. *\n" +
                    "<b>/ustatus</b> = displays status of UBCKRE settings.\n" +
                    "<b>/unrestrict</b> =  partially removes restrictions from game. * </p>\n"
                );
            }
            if (args === "settings") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Settings commands - * = more info when using\n" +
            ...
            if (args === "talking") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Talking commands - * = more info when using\n" +
            ...
            if (args === "visual") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Visual commands - * = more info when using\n" +
            ...
            if (args === "zones") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: Zones commands - * = more info when using\n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The unlock command:\n" +
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The unrestrict command partially removes restrictions from game. It must be followed by an option.\n" +
		    ...
		    "Notes: \n" +
                ...
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'>UBCKRE: Unrestricted softly. Can do some things you couldn't do before.\n" +
                    "Store also includes hidden items. This can only be reset via a full relog.</p>"
                );
            } else if (args === "total") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'>UBCKRE: Unrestricted totally. Can do many things you couldn't do before.\n" +
                    "Store also includes hidden items. This can only be reset via a full relog.</p>"
                );
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The uset command must be followed by an option corresponding to an UBC setting.\n" +
                    " \n" +
                    "Available options:\n" +
		    ...
		    "<b>outbuttons</b> to toggle OUT buttons\n" +
                ...
                if (setting == "autojoin") {
                    if (AutojoinOn == true) {
                        ...
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: Auto-Join feature is disabled.</p>"
                        );
                    } else {
                        AutojoinOn = true;
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                             "<p style='background-color:#5fbd7a'>UBCKRE: Auto-Join feature is enabled.</p>"
                        );
                    }
                    ...
                    if (SlowleaveOn == true) {
                        ...
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: Fast exit mode is activated.</p>"
                        );
                    } else {
                        SlowleaveOn = true;
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: Slow exit mode is activated.</p>"
                        );
                    }
                    ...
                    if (FullseedOn == true) {
                        ...
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: Full solution for intricate and high security locks is disabled.</p>"
                        );
                    } else {
                        FullseedOn = true;
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: Full solution for intricate and high security locks is enabled.</p>"
                        );
                    }
                    ...
                    if (HighfameOn == true) {
                        ...
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: High fame mode disabled in Bondage Club Card Game.</p>"
                        );
                    } else {
                        HighfameOn = true;
                        ClubCardFameGoal = cfame;
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: High fame mode enabled in Bondage Club Card Game.</p>"
                        );
                    }
                    ...
                    if (HotkeysOn == true) {
                        ...
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: Hotkeys on numeric pad are disabled.</p>"
                        );
                    } else {
                        HotkeysOn = true;
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: Hotkeys on numeric pad are enabled.</p>"
                        );
                    }
                    ...
                    if (MagiccheatOn == true) {
                        ...
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: Cheat mode disabled in Bondage Brawl and Magic School.</p>"
                        );
                    } else {
                        MagiccheatOn = true;
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                             "<p style='background-color:#5fbd7a'>UBCKRE: Cheat mode enabled in Bondage Brawl and Magic School.</p>"
                        );
                    }
                    ...
                    if (NowhisperOn == true) {
                        ...
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: No-whisper mode disabled.</p>"
                        );
                    } else {
                        NowhisperOn = true;
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: No-whisper mode enabled.</p>"
                        );
                    }
                    ...
                    if (Player.RestrictionSettings.BypassNPCPunishments == true) {
                        ...
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: NPC punishments enabled.</p>"
                        );
                    } else {
                        Player.RestrictionSettings.BypassNPCPunishments = true;
                        NPCpunish = false;
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: NPC punishments disabled.</p>"
                        );
                    }
                    ...
                    if (OutbuttonsOn == true) {
                        ...
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: OUT buttons hidden and disabled.</p>"
                        );
                    } else {
                        OutbuttonsOn = true;
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: OUT buttons displayed and enabled.</p>"
                        );
                    }
                    ...
                    if (SosbuttonsOn == true) {
                        ...
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: Emergency buttons hidden and disabled.</p>"
                        );
                    } else {
                        SosbuttonsOn = true;
                        M_MOANER_saveControls();
                        ChatRoomSendLocal(
                            "<p style='background-color:#5fbd7a'>UBCKRE: Emergency buttons displayed and enabled.</p>"
                        );
                    }
                }
            }    
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The vrsee command must be followed by 3 numbers for background, mode and game.\n" +
                    " \n" +
                ...
                if (InventoryGet(Player, "ItemHead") != null) {
                    if (InventoryGet(Player, "ItemHead").Asset.Name == "InteractiveVRHeadset") {
                        ...
                        if ((bvr > -1) && (bvr < 6) && (fvr > -1) && (fvr < 4) && (gvr > -1) && (gvr < 2)) {
                            ...
                            ChatRoomCharacterUpdate(Player);
                            ChatRoomSendLocal(
                                "<p style='background-color:#5fbd7a'>UBCKRE: The settings of your VR Headset have been modified.</p>"
                            );
                        }
                    }
                }
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            if (args === "") {
                ChatRoomSendLocal(
                    "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The xstatus command must be followed by an option corresponding to an add-on.\n" +
                    " \n" +
                    "Available options:\n" +
                    "bcar for BCAR\n" +
    ...
    CommandCombine([{
        ...
        Action: (_, command, args) => {
            if (NowhisperOn == false) {
                ...
                if (!targetname) {
                    ChatRoomSendLocal(
                        "<p style='background-color:#5fbd7a'><b>UBCKRE</b>: The whisper command must be followed by a target and the message you want to whisper.\n" +
